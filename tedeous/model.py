...
class Model():
    ...
    def train(self,
        ...
        if rl_agent_params:
            ...
            # rl_agent.replay_buffer = collect_all_comet_transitions(rl_agent.replay_buffer, max_exps_last=100, tolerance = rl_agent_params["tolerance"],prev_tol= rl_agent_params["prev_tol"])
