...
from tedeous.optimizers.closure_test import Closure
...
class Model():
    ...
    def train(self,
        ...
        """
        self.dict_of_learning =  {"learning_f_p_losses" : [],
                                  "learning_swarm_losses" : []}
        self.t = 1
        ...
        while self.t < epochs and self.stop_training == False:
            ...
            self.dict_of_learning["learning_f_p_losses"].append(self.optimizer.f_p.tolist())
