...
experiment = start(
  ...
  project_name="rlpinn_convection_diffusion_1d_farm_transitions",
  workspace="saitama32"
)
...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "farm_transitions_convection_diffusion_1d_basic_RL_optimizer"
})
...
if __name__ == "__main__":
    ...
    exp_dict_list = convection_diffusion_1d_experiment(grid_res)