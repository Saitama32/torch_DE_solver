...
experiment.log_parameters({
    "param": "v_1",
    "reward_function": "v_2",
    "description": "comparison_poisson_2d_cg_RL_optimizer"
})
...
def poisson_2d_irregular_geometry_experiment(grid_res, log_key=None, exp_key=None):
    if log_key == "True":
        log_key = True
    elif log_key == "False":
        log_key = False    
...
if __name__ == "__main__":
    ...
    seeds = [123, 789]   # можно расширить список
    ...
    for seed in seeds:
        ...
        exp_dict_list = poisson_2d_irregular_geometry_experiment(grid_res, log_key=args.log_key, exp_key=args.exp_key)
