...
from _aux.earlystopping import EarlyStopping
from _aux.losses import loss_grid_to_trajectory, rec_loss_function, loss_anchor
from _aux.trajectories_data import get_trajectory_dataloader, get_anchor_dataloader, get_predefined_values
from _aux.utils import get_files, get_gridpoint_and_trajectory_datasets, loss_well_spaced_trajectory, plot_losses
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='equations training')
    ...
    parser.add_argument('--anchor_mode', default="circle", type=str, help='anchor shape') #"circle"#"diagonal"
